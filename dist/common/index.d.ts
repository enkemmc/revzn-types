...
export type DeepNullable<T> = T extends null ? null : {
    [P in keyof T]?: T[P] extends (infer U)[] ? DeepNullable<U>[] : T[P] extends ReadonlyArray<infer U> ? ReadonlyArray<DeepNullable<U>> : T[P] extends object ? DeepNullable<T[P]> : T[P] | null;
};
